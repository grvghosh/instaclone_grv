  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (allowedExtensionts.includes(imgExt.toLowerCase())) {
        ...
        //const response = await fetch("https://desolate-plateau-68297.herokuapp.com/api/post/add", {
          const response = await fetch("http://localhost:3004/api/post/add", {
            // const response = await fetch("https://grv-insta-server.herokuapp.com/api/post/add", {
          method: "POST",
          headers: {},
          body: formData,
        });
    ...
    <>
      ...
      <div className="add-post-container">
        <form
          ...
          // action="https://grv-insta-server.herokuapp.com/api/post/add"
          method="post"
          className="post-form"
